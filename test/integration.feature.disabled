Feature: all integrations print the correct messages
  ...
  Background: 
    Given variable subject is "Case number citrus:randomString(10)"
    ...
    And HTTP request body:  {  "Subject" : "${subject}", "Description" : "${description}" }
  ...
  Scenario:
    ...
    And integration salesforce-to-service-now should print New Case created: ID: 
